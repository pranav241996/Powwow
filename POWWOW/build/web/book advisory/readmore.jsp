...
/*             
    ...
    <body>
        ...
        <%
         ...
         <div class="modal-header">
            <h1 align="center" style="color: blue;  font-size: 48px"><%=subject%></h1>
        </div>
        ...
        <div class="modal-body" style="min-height:  200px;">
         ...
         <img src="<%="../BookImageLoader?bcover="+bm.getBookcover()%>" style="height: 380px; width: 300px">
          ...
          <div id="namerating">
              <br/>
             <b style="color: blue;  font-size: 32px"><%=bm.getBookname()%></b><br/><br/>
   ...
   <br/><br/>  <b style='font-size: 24px'>Your Rating </b>
                 ...
                 <div id="price" style="font-size: 32px; color: red">
                     ...
                     PRICE: <b style="font-size: 44px; color: blue"><i class="rupee icon"></i><%=bm.getBookprice()%><b/>
                 </div>
