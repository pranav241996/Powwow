					...
					<div class="collapse navbar-collapse">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<div class="form-group  is-empty">
                                                            <input type="text" id="search" name="search" class="form-control searchs" style="width:400px" placeholder="Search -- Question,  @Username,  #Workspaces">
                    ...
                    <div class="card-content">
	                    <div class="category"><a href="../GoToUserProfile?id=<%= qm.getUid() %>" style="color: #0099cc;"> <%= qm.getUname() %></a> asked in 
	                        ...
	                        <%for(String tags: qm.getTags() ){%>
                                ...
                                <h3 style="margin-top: 5px;margin-bottom: 5px;font-weight: bold;"><a href="../AllAnswer?id=<%=i%>" style=" color: black;"><%= qm.getQue() %></a></h3>
        ...
        for (var i = 0; i < ansElements.length; i++)
        {
            ...
            ansElements[i].id = 'ans' + i;
                ...
                <%}%>
                                ...
                                <div class="col-md-4 col-sm-12 animated fadeInDown" style="position: absolute; top: 10px; left: 800px;">
				<div class="card">
						<div class="card-content card-title">
							<h4>Questions For You :</h4>
							<%if(rlqm1!=null){int i=0; for(QuestionModel qm: rlqm1.getRelatedque()){ %>
							<p>
                                                            <a href="../QuestionForYou?id=<%=i%>" style="color: #0099cc;"><%= qm.getQue() %></a>
							</p>
                                                        <%i++;}}%>
						</div>
					</div>
			...
			<footer class="footer">
				<div class="container-fluid">
					...
					<p class="copyright pull-right">
						&copy; <script>document.write(new Date().getFullYear())</script> , made with love <i class="fa fa-heart"></i>for a better web
					</p>
				</div>
			</footer>
