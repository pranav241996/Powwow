...
<!--    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>-->
    ...
    <link href="css/quepage.css" rel="stylesheet">
            ...
            <div class="container" >
                ...
                <div class="collapse navbar-collapse" id="navbarNav1">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="questionmodal.jsp">Ask a question</a>
                        </li>
                    ...
                    <form class="form-inline waves-effect waves-light" action="../AskQuestion" class="navbar-form navbar-right" role="search">
    ...
    <main class="mt-3" style="margin-right: 0px;">
        ...
        <div class="container" style="margin-left: 60px;margin-right:0px;">
            <div class="row">
                ...
                <%if(qm!=null){%>
                    <div class="jumbotron">
                        <mark> <a href="../GoToUserProfile?id=<%= qm.getUid() %>"><%= qm.getUname() %></a> asked
                        </mark>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="media mb-1">
                                ...
                                <div class="media-body">
                                    <h5 class="media-heading"><a href="../GoToUserProfile?id=<%= am.getUid() %>"><%= am.getUname() %></a></h5>
                                    ...
                                    <button value="upvote&qid=<%=am.getQid()%>&uid=<%=am.getUid()%>" class="up btn btn-info btn-sm" onclick="upvote(<%=i%>)"><i class="fa fa-thumbs-up"></i>&nbsp;WOW</button>
                                    <span class="votecount"> <%=am.getUpvotes()%></span>
                                    <button value="downvote&qid=<%=am.getQid()%>&uid=<%=am.getUid()%>"  class="black-background black down btn btn-info btn-sm " onclick="downvote(<%=i%>)"><i class=" fa fa-thumbs-down"></i>&nbsp;DISWOW</button>
                                    <button value="qid=<%=am.getQid()%>&uid=<%=am.getUid()%>" class="report btn btn-danger btn-sm" onclick="report(<%=i%>)">REPORT ABUSE<i class="fa fa-ban float-right" style="color: #FF0000;"></i></button>    
                ...
                <div class="col-lg-3" style="max-width: 100%;">
                    ...
                    <div class="widget-wrapper wow fadeIn" id="stck" data-wow-delay="0.4s">
                        ...
                        <div class="card card-block">
                            <a href="">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi cupiditate temporibus iure soluta?</a><br>
                            <a href="">nemo quam accusamus possimus, voluptatum expedita assumenda. Earum sit id ullam eum vel delectus?</a>
                        </div>
                    </div>
                </div>
                /.Sidebar-->
...
//        console.log(arg);
        ...
        success : function(data) {
            ...
            window.location="QuePage.jsp?flag=true";
           ...
           if(document.getElementById("answerarea").style.display==="none")
        {
           ...
           console.log(quill);
            if(document.getElementById("ansbtn").innerHTML==="Edit Answer")
            {
