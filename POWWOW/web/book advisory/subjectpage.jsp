...
<html>
    <head>
        ...
        <title>BOOK ADVISORY</title>
         <link rel="icon" type="image/png" href="../images/logo.png" />
         <link href="../nav-sidebar/css/bootstrap.min.css" rel="stylesheet" />

    <!--  Material Dashboard CSS    -->
    <link href="../nav-sidebar/css/material-dashboard.css" rel="stylesheet"/>

    <!--  CSS for Demo Purpose, don't include it in your project     -->
    <link href="../nav-sidebar/css/demo.css" rel="stylesheet" />

    <!--     Fonts and icons     -->
    <link href="../MDB Free/font-awesome-4.7.0/css/font-awesome.min.css" rel="stylesheet">
    <link href='http://fonts.googleapis.com/css?family=Roboto:400,700,300|Material+Icons' rel='stylesheet' type='text/css'>
    
    <script src="../nav-sidebar/js/jquery-3.1.0.min.js" type="text/javascript"></script>
	<script src="../nav-sidebar/js/bootstrap.min.js" type="text/javascript"></script>
	<script src="../nav-sidebar/js/material.min.js" type="text/javascript"></script>

	 
	<script src="../nav-sidebar/js/chartist.min.js"></script>
    
	<script src="../nav-sidebar/js/bootstrap-notify.js"></script>

	
	<script src="../nav-sidebar/js/material-dashboard.js"></script>
